...
function Register() {
  ...
  const validate = () => {
    ...
    if (!formData.email) {
      ...
      newErrors.email = "Enter a valid .edu email.";
    }
    ...
    if (formData.role === "faculty") {
      ...
      if (!formData.researchAreas) newErrors.researchAreas = "Areas of Research required.";
    }
            ...
            <>
              ...
              <div className="input-group">
                ...
                {errors.researchAreas && (
                  <p className="error">{errors.researchAreas}</p>
                )}
              </div>
            </>
          )}
